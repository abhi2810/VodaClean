...
public class BCM extends AppCompatActivity {
    ...
    String[] SPINNERLIST = {"Riots:", "Floods:", "Earthquake:"};
    @Override
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(disc.getText().toString().equals("")||city.getText().toString().equals("")||floor.getText().toString().equals("")||loc.getText().toString().equals("")||materialDesignSpinner.getText().toString().equals("")) {
                    Toast.makeText(BCM.this, "Fields Can't be empty!", Toast.LENGTH_SHORT).show();
                }else
                    uploadImage();
                disc.requestFocus();
            }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(BCM.this, s , Toast.LENGTH_LONG).show();
                        disc.setText("");
                        city.setText("");
                        loc.setText("");
                        floor.setText("");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        if(volleyError.getMessage()!=null)
                            Toast.makeText(BCM.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                        else{
                            disc.setText("");
                            city.setText("");
                            loc.setText("");
                            ...
                            materialDesignSpinner.setText("");
                            imageView.setImageResource(0);
                            Toast.makeText(BCM.this, "Succesfully Submitted!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }){
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.item1:
                ...
                LayoutInflater factory = LayoutInflater.from(BCM.this);
                ...
                dialog.setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                Toast.makeText(BCM.this,"Thanks",Toast.LENGTH_SHORT).show();
                            }
                        });
                dialog.setView(view);
                dialog.show();
            ...
            case R.id.action_settings:
                ...
                dial.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface arg0, int arg1) {
                                Toast.makeText(BCM.this, "Logged Out", Toast.LENGTH_SHORT).show();
                                Intent i=new Intent(BCM.this,MainActivity.class);
